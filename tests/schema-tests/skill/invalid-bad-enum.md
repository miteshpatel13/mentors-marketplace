---
name: invalid-bad-enum
description: Fixture Skill with invalid category and skillType values, for regression testing scripts/validate_skill.py.
category: Backendish
skillType: Reviewer
---

# Invalid Bad Enum Fixture

## Purpose

Confirms invalid enum values are reported individually.
...
2. Confirm two `E_INVALID_ENUM` errors (category, skillType).
